package com.ucarrer.builder.landing.web;


import com.ucarrer.builder.core.CoreResponseBody;
import com.ucarrer.builder.user.User;
import com.ucarrer.builder.user.UserService;
...
public class LandingController {
    ...
    public ResponseEntity<CoreResponseBody> update(@RequestHeader("Authorization") String authHeader, @RequestBody Builder builder) {
        CoreResponseBody res;
        String token = this.getJwtTokenFromHeader(authHeader);
        if (token == "") {
            res = new CoreResponseBody(null, "invalid token", new Exception("invalid token"));
...
//        Builder b = builderRepository.getOne(builder.getId());
    ...
    public ResponseEntity<CoreResponseBody> save(@RequestHeader("Authorization") String authHeader, @RequestBody Builder builder) {
        CoreResponseBody res;
